...
class Setxattr : public detail::IORegistrator<Setxattr, decltype(io_uring_prep_setxattr)> {
private:
    using Super = detail::IORegistrator<Setxattr, decltype(io_uring_prep_setxattr)>;
